...
return array(
    ...
    'Announcements' => $baseDir . '/core/classes/Misc/Announcements.php',
    'AssetResolver' => $baseDir . '/core/classes/Templates/AssetResolver.php',
    'AssetTree' => $baseDir . '/core/classes/Templates/AssetTree.php',
    'Attribute' => $vendorDir . '/symfony/polyfill-php80/Resources/stubs/Attribute.php',
    'AvatarSource' => $baseDir . '/core/classes/Avatars/AvatarSource.php',
    'AvatarSourceBase' => $baseDir . '/core/classes/Avatars/AvatarSourceBase.php',
    'Bulletproof\\Image' => $vendorDir . '/samayo/bulletproof/src/bulletproof.php',
    'Cache' => $baseDir . '/core/classes/Core/Cache.php',
    'CaptchaBase' => $baseDir . '/core/classes/Misc/CaptchaBase.php',
    'CloneGroupForumHook' => $baseDir . '/modules/Forum/hooks/CloneGroupForumHook.php',
    'CloneGroupHook' => $baseDir . '/modules/Core/hooks/CloneGroupHook.php',
    'Collection' => $baseDir . '/core/classes/Collections/Collection.php',
    'CollectionItemBase' => $baseDir . '/core/classes/Collections/CollectionItemBase.php',
    'CollectionManager' => $baseDir . '/core/classes/Collections/CollectionManager.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'Config' => $baseDir . '/core/classes/Core/Config.php',
    'Configuration' => $baseDir . '/core/classes/Core/Configuration.php',
    'ContentHook' => $baseDir . '/modules/Core/hooks/ContentHook.php',
    'Cookie' => $baseDir . '/core/classes/Core/Cookie.php',
    'CookieConsent' => $baseDir . '/modules/Cookie Consent/classes/CookieConsent.php',
    'CookieConsent_Sitemap' => $baseDir . '/modules/Cookie Consent/classes/CookieConsent_Sitemap.php',
    'CoreApiErrors' => $baseDir . '/modules/Core/classes/Misc/CoreApiErrors.php',
    'Core_Sitemap' => $baseDir . '/modules/Core/classes/Misc/Core_Sitemap.php',
    'CrafatarAvatarSource' => $baseDir . '/modules/Core/classes/Avatars/CrafatarAvatarSource.php',
    'CraftheadAvatarSource' => $baseDir . '/modules/Core/classes/Avatars/CraftheadAvatarSource.php',
    'CravatarAvatarSource' => $baseDir . '/modules/Core/classes/Avatars/CravatarAvatarSource.php',
    'DB' => $baseDir . '/core/classes/Database/DB.php',
    'DatabaseInitialiser' => $baseDir . '/core/classes/Database/DatabaseInitialiser.php',
    'DebugBarHelper' => $baseDir . '/core/classes/Misc/DebugBarHelper.php',
    'Debugging' => $baseDir . '/core/classes/Misc/Debugging.php',
    'DeleteUserForumHook' => $baseDir . '/modules/Forum/hooks/DeleteUserForumHook.php',
    'DeleteUserHook' => $baseDir . '/modules/Core/hooks/DeleteUserHook.php',
    'Discord' => $baseDir . '/modules/Discord Integration/classes/Discord.php',
    'DiscordApiErrors' => $baseDir . '/modules/Discord Integration/classes/DiscordApiErrors.php',
    'DiscordFormatterHook' => $baseDir . '/modules/Discord Integration/hooks/DiscordFormatterHook.php',
    'DiscordGroupSyncInjector' => $baseDir . '/modules/Discord Integration/classes/DiscordGroupSyncInjector.php',
    'DiscordHook' => $baseDir . '/modules/Discord Integration/hooks/DiscordHook.php',
    'DiscordIntegration' => $baseDir . '/modules/Discord Integration/classes/DiscordIntegration.php',
    'DiscordWidget' => $baseDir . '/modules/Discord Integration/widgets/DiscordWidget.php',
    'Email' => $baseDir . '/core/classes/Core/Email.php',
    'EndpointBase' => $baseDir . '/core/classes/Endpoints/EndpointBase.php',
    'Endpoints' => $baseDir . '/core/classes/Endpoints/Endpoints.php',
    ...
    'GroupSyncManager' => $baseDir . '/core/classes/Group_Sync/GroupSyncManager.php',
    'Hash' => $baseDir . '/core/classes/Core/Hash.php',
    'HookBase' => $baseDir . '/core/classes/Events/HookBase.php',
    'HttpClient' => $baseDir . '/core/classes/Core/HttpClient.php',
    'HttpUtils' => $baseDir . '/core/classes/Misc/HttpUtils.php',
    'Input' => $baseDir . '/core/classes/Core/Input.php',
    'Instanceable' => $baseDir . '/core/classes/Core/Instanceable.php',
    'IntegrationBase' => $baseDir . '/core/classes/Integrations/IntegrationBase.php',
    'IntegrationData' => $baseDir . '/core/classes/DTO/IntegrationData.php',
    'IntegrationUser' => $baseDir . '/core/classes/Integrations/IntegrationUser.php',
    'IntegrationUserData' => $baseDir . '/core/classes/DTO/IntegrationUserData.php',
    ...
    'LatestPostsWidget' => $baseDir . '/modules/Forum/widgets/LatestPostsWidget.php',
    'Log' => $baseDir . '/core/classes/Core/Log.php',
    'MCAssoc' => $baseDir . '/core/classes/Minecraft/MCAssoc.php',
    'MCHeadsAvatarSource' => $baseDir . '/modules/Core/classes/Avatars/MCHeadsAvatarSource.php',
    'MCQuery' => $baseDir . '/core/classes/Minecraft/MCQuery.php',
    'ManagesTransformers' => $baseDir . '/core/classes/Endpoints/ManagesTransformers.php',
    'MatchesRoutes' => $baseDir . '/core/classes/Endpoints/MatchesRoutes.php',
    'MentionsHook' => $baseDir . '/modules/Core/hooks/MentionsHook.php',
    'MentionsParser' => $baseDir . '/core/classes/Misc/MentionsParser.php',
    'MinecraftGroupSyncInjector' => $baseDir . '/modules/Core/classes/Group_Sync/MinecraftGroupSyncInjector.php',
    'MinecraftIntegration' => $baseDir . '/modules/Core/classes/Integrations/MinecraftIntegration.php',
    'MinecraftProfile' => $baseDir . '/core/classes/Minecraft/MinecraftProfile.php',
    ...
    'Nameless2API' => $baseDir . '/modules/Core/classes/Misc/Nameless2API.php',
    'NamelessMCAvatarSource' => $baseDir . '/modules/Core/classes/Avatars/NamelessMCAvatarSource.php',
    'NamelessMCGroupSyncInjector' => $baseDir . '/modules/Core/classes/Group_Sync/NamelessMCGroupSyncInjector.php',
    'NamelessOAuth' => $baseDir . '/core/classes/Misc/NamelessOAuth.php',
    ...
    'OnlineStaffWidget' => $baseDir . '/modules/Core/widgets/OnlineStaffWidget.php',
    'OnlineUsersWidget' => $baseDir . '/modules/Core/widgets/OnlineUsersWidget.php',
    'Output' => $baseDir . '/core/classes/Core/Output.php',
    'Pages' => $baseDir . '/core/classes/Core/Pages.php',
    'Paginator' => $baseDir . '/core/classes/Core/Paginator.php',
    'PermissionHandler' => $baseDir . '/core/classes/Core/PermissionHandler.php',
    'PhinxAdapter' => $baseDir . '/core/classes/Database/PhinxAdapter.php',
    ...
    'Queries' => $baseDir . '/core/classes/Database/Queries.php',
    'QueryRecorder' => $baseDir . '/core/classes/Database/QueryRecorder.php',
    'Recaptcha2' => $baseDir . '/modules/Core/classes/Captcha/Recaptcha2.php',
    'Recaptcha3' => $baseDir . '/modules/Core/classes/Captcha/Recaptcha3.php',
    'Redirect' => $baseDir . '/core/classes/Core/Redirect.php',
    'Report' => $baseDir . '/core/classes/Misc/Report.php',
    ...
    'StatsWidget' => $baseDir . '/modules/Core/widgets/StatsWidget.php',
    ...
    'TemplateBase' => $baseDir . '/core/classes/Templates/TemplateBase.php',
    'Text' => $baseDir . '/core/classes/Misc/Text.php',
    'TimeAgo' => $baseDir . '/core/classes/Core/TimeAgo.php',
    'Token' => $baseDir . '/core/classes/Core/Token.php',
    ...
    'ValidateHook' => $baseDir . '/modules/Core/hooks/ValidateHook.php',
    'ValueError' => $vendorDir . '/symfony/polyfill-php80/Resources/stubs/ValueError.php',
    'VisageAvatarSource' => $baseDir . '/modules/Core/classes/Avatars/VisageAvatarSource.php',
    'WebHook' => $baseDir . '/modules/Core/hooks/WebHook.php',
